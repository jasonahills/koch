...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13692 = (0);while(true){
var m_13693 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13693 == null))
{} else
{m_13693.call(null);
if((count_13692 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13694 = (count_13692 + (1));
count_13692 = G__13694;
continue;
}
} else
{}
