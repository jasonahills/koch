...
{return cljs.core.reduce.call(null,(function (result,p__13719){var vec__13720 = p__13719;var k = cljs.core.nth.call(null,vec__13720,(0),null);var v = cljs.core.nth.call(null,vec__13720,(1),null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__13722 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__13722,(0),null);var b_STAR_ = cljs.core.nth.call(null,vec__13722,(1),null);var ab = cljs.core.nth.call(null,vec__13722,(2),null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true, false):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true, false):null),((same)?new cljs.core.PersistentArrayMap.fromArray([k,ab], true, false):null)], null);
});
/**
...
clojure.data.EqualityPartition = (function (){var obj13724 = {};return obj13724;
})();
...
clojure.data.Diff = (function (){var obj13726 = {};return obj13726;
})();
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__13727 = x;if(G__13727)
{var bit__4203__auto__ = (G__13727.cljs$lang$protocol_mask$partition0$ & (1024));if((bit__4203__auto__) || (G__13727.cljs$core$IMap$))
{return true;
} else
{if((!G__13727.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__13727);
} else
{return false;
}
}
...
{if((function (){var G__13728 = x;if(G__13728)
{var bit__4203__auto__ = (G__13728.cljs$lang$protocol_mask$partition0$ & (4096));if((bit__4203__auto__) || (G__13728.cljs$core$ISet$))
{return true;
} else
{if((!G__13728.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__13728);
} else
{return false;
}
}
...
{if((function (){var G__13729 = x;if(G__13729)
{var bit__4203__auto__ = (G__13729.cljs$lang$protocol_mask$partition0$ & (16777216));if((bit__4203__auto__) || (G__13729.cljs$core$ISequential$))
{return true;
} else
{if((!G__13729.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__13729);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__13730 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);switch (G__13730) {
case "map":
