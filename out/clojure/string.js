...
{{
var G__13703 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13703;
continue;
}
} else
...
{var pred__13707 = cljs.core._EQ_;var expr__13708 = limit;if(cljs.core.truth_(pred__13707.call(null,(1),expr__13708)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13707.call(null,(2),expr__13708)))
...
var G__13710 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13711 = (limit__$1 - (1));
var G__13712 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__13710;
limit__$1 = G__13711;
parts = G__13712;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13714 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13714))
{var replacement_13715 = temp__4124__auto___13714;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13715)));
} else
{buffer.append(ch);
}
{
var G__13716 = (index + (1));
index = G__13716;
continue;
}
}
